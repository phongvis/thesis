...
\subsubsection*{1. How can we design interactive visualizations of \strong{timestamped provenance data} that enables users to explore \strong{temporal relationships in sensemaking}?}
...
\subsubsection*{2. How can we design interactive visualizations that can reveal both \strong{temporal and categorical dimensions of provenance data} and enable users to explore more \strong{complex temporal relationships in sensemaking}?}
...
\subsubsection*{3. How can we design interactive visualization tools for \strong{timestamped provenance data} that enables analysts to explore \strong{reasoning relationships in sensemaking} performed by other users?}
...
\subsubsection*{4. How can we design interactive visualization tools for \strong{timestamped provenance data} that can incorporate \strong{user-added relations} and enable users to explore more \strong{complex reasoning relationships in sensemaking}?}
