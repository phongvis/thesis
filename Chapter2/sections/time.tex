...
\caption{Three charts showing the same time-series dataset with the horizontal axis representing time and the vertical axis representing a numerical value. \is{Aigner2011}}
...
\caption{Horizon Graph: a space-efficient visualization of time-series data compared to line chart. \is{Reijner2008}}
...
\begin{figure}[!htb]
	...
	\caption{ThemeRiver uses a river metaphor to represent themes with each colored current corresponding to a theme. The data is a collection of Fidel Castro's speeches, interviews and articles from the end of 1959 to mid-1961. \is{Havre2002}}
...
\begin{figure}[!htb]
\centering
\subcaptionbox{Traditional stacked graph with the baseline at 0. \label{fig:lr-streamgraph-1}}{\includegraphics[width=\columnwidth]{streamgraph-1}}

\vspace{0.5cm}

\subcaptionbox{ThemeRiver aiming for a symmetric layout around the horizontal  xis. \label{fig:lr-streamgraph-2}}{\includegraphics[width=\columnwidth]{streamgraph-2}}

\vspace{0.5cm}

\subcaptionbox{Stream Graph minimizing the number of wiggles of layers. \label{fig:lr-streamgraph-3}}{\includegraphics[width=\columnwidth]{streamgraph-3}}
...
\begin{figure}[!htb]
	...
	\caption{Gantt chart. Each task is shown in an individual row with task name on the left and horizontal bar on the right, covering the task time. Arrows show dependency, and label indentation indicates the hierarchy of tasks. \is{Aigner2011}}
...
\begin{figure}[!htb]
	...
	\caption{TimeNet visualization of genealogical data. Lifelines represent people with converging lines signifying marriage, and dotted lines indicating children. \is{Kim2010}}
...
\begin{figure}[!htb]
\centering
\subcaptionbox{Cross section of a Douglas Fir tree showing its tree-rings. \is{Theron2006} \label{fig:lr-circle-view-1}}{\includegraphics[height=.465\columnwidth]{tree-ring}}
\hfill
\subcaptionbox{Circle View showing six variables over ten time steps. \is{Keim2004} \label{fig:lr-circle-view-2}}{\includegraphics[height=.465\columnwidth]{circle-view}}
...
\begin{figure}[!htb]
\centering
\subcaptionbox{Hierarchy is shown as a tree with temporal values annotated next to the nodes. \label{fig:lr-tree-ring-time}}[.48\columnwidth]{\includegraphics[height=.4\columnwidth]{tree-ring-time}}
\hfill
...
\caption{Tree rings encoding both temporal and hierarchical information at the same time. \is{Theron2006}}
\end{figure}
