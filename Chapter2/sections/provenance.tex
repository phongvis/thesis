...
\begin{figure}
\centering
\subcaptionbox{A sequence of icons representing the analysis process. \is{Gotz2009}\label{fig:lr-action-1}}[\columnwidth]{\includegraphics[width=.75\columnwidth]{action-1}}

\vspace{.5\baselineskip}

\subcaptionbox{Iconic actions connecting two visualization states. \is{Ma1999}\label{fig:lr-action-2}}[\columnwidth]{\includegraphics[width=.75\columnwidth]{action-2}}
...
\begin{figure}
	\centering
	\includegraphics[width=.7\columnwidth]{enhanced-thumbnail}
...
\begin{figure}
\centering
\subcaptionbox{Modified items are highlighted with green borders. \is{Klemmer2002}\label{fig:lr-state-2}}[.47\columnwidth]{\includegraphics[height=.3\columnwidth]{state-2}}
\hfill
\subcaptionbox{Changed area is focused and shown in both  states. \is{Kurlander1988}\label{fig:lr-state-3}}[.47\columnwidth]{\includegraphics[height=.3\columnwidth]{state-3}}
...
\begin{figure}
\centering
\subcaptionbox{Time-point provenance data. User annotations are positioned along a time axis at when their associated events happen. \is{Gotz2006}\label{fig:lr-continuous-timeline-1}}[\columnwidth]{\includegraphics[width=\columnwidth]{continuous-timeline-1}}

\vspace{.5\baselineskip}

\subcaptionbox{Interval provenance data. User actions are shown as horizontal bars a long a time axis covering their durations. \is{Plaisant1999}\label{fig:lr-continuous-timeline-2}}[\columnwidth]{\includegraphics[width=\columnwidth]{continuous-timeline-2}}
