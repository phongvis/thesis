...
\begin{figure}[!htb]
	\centering	
	\includegraphics[width=.7\linewidth]{provenance-graph}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=.7\columnwidth]{Gotz-Zhou-model}
...
\begin{figure}[!htb]
\centering
\subcaptionbox{A sequence of icons representing the analysis process. \is{Gotz2009}\label{fig:lr-action-1}}[\columnwidth]{\includegraphics[width=.7\columnwidth]{action-1}}

\vspace{.5\baselineskip}

\subcaptionbox{Iconic actions connecting two visualization states. \is{Ma1999}\label{fig:lr-action-2}}[\columnwidth]{\includegraphics[width=.7\columnwidth]{action-2}}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=.8\columnwidth]{thumbnail-encoding}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=.65\columnwidth]{enhanced-thumbnail}
...
\begin{figure}[!htb]
\centering
\subcaptionbox{Modified items are highlighted with green borders. \is{Klemmer2002}\label{fig:lr-state-2}}[.47\columnwidth]{\includegraphics[height=.25\columnwidth]{state-2}} 
\hfill
\subcaptionbox{Changed area is focused and shown in both  states. \is{Kurlander1988}\label{fig:lr-state-3}}[.47\columnwidth]{\includegraphics[height=.25\columnwidth]{state-3}}
...
\begin{figure}[!htb]
\centering
\subcaptionbox{Time-point provenance data. User annotations are positioned along a time axis at when their associated events happen. \is{Gotz2006}\label{fig:lr-continuous-timeline-1}}[\columnwidth]{\includegraphics[width=.7\columnwidth]{continuous-timeline-1}}

\vspace{.5\baselineskip}

\subcaptionbox{Interval provenance data. User actions are shown as horizontal bars a long a time axis covering their durations. \is{Plaisant1999}\label{fig:lr-continuous-timeline-2}}[\columnwidth]{\includegraphics[width=.7\columnwidth]{continuous-timeline-2}}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=.7\columnwidth]{timeline-2d}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=.5\columnwidth]{tree}
...
\begin{figure}[!htb]
\centering
\subcaptionbox{Zooming in to work on the active visualization.\label{fig:lr-detail}}[0.33\columnwidth]{\includegraphics[height=0.45\columnwidth]{GraphTrail-detail}} 
\hfill
\subcaptionbox{Zooming out to see an overview as the history of the exploration process.\label{fig:lr-overview}}[0.57\columnwidth]{\includegraphics[height=0.45\columnwidth]{GraphTrail-overview}}
...
\begin{figure}[!htb]
\centering
\subcaptionbox{Geometric annotation.\label{fig:lr-annotation-1}}{\includegraphics[height=0.5\columnwidth]{annotation-1}} 
\hspace{1cm}
\subcaptionbox{Data-aware annotation.\label{fig:lr-annotation-2}}{\includegraphics[height=0.5\columnwidth]{annotation-2}}
...
\begin{figure}[!htb]
\centering
\subcaptionbox{A diagram of user notes showing their thoughts. \is{Shrinivasan2008}\label{fig:lr-reasoning-simple-note}}{\includegraphics[height=0.4\columnwidth]{reasoning-simple-note}}
\hfill
\subcaptionbox{A formal reasoning diagram with nodes having different roles: evidence, casual relationship, assumption and hypothesis. \is{Pike2009a}\label{fig:lr-reasoning-diagram-SRS}}{\includegraphics[height=.4\columnwidth]{reasoning-diagram-SRS}}
