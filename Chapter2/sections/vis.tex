...
\begin{figure}[!htb]
\centering
\subcaptionbox{Categorical colormap with distinguishable color hues.\label{fig:lr-Migut1}}[\columnwidth]{\includegraphics[width=\columnwidth]{clas-Migut1}} 
\\
\subcaptionbox{Sequential colormap: a single color hue with different saturation level.\label{fig:lr-Migut2}}[\columnwidth]{\includegraphics[width=\columnwidth]{clas-Migut2}}
\caption{Colormaps from ColorBrewer. \is{Migut2010}}
\end{figure}
