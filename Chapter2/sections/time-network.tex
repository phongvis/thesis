...
\begin{figure}[p]
	...
	\subcaptionbox{Spiral time axis showing two variables (yellow and red). \is{Weber2001} \label{fig:lr-time-spiral}}[.47\columnwidth]{\includegraphics[height=.35\columnwidth]{spiral}}
	\hfill
	...
	\\ \vspace{.5\baselineskip}
	\subcaptionbox{Calendar visualization of a 6-month data of daily power consumption. \is{VanWijk1999} \label{fig:lr-time-calendar}}{\includegraphics[width=\columnwidth]{calendar-crop}}
	\\ \vspace{.5\baselineskip}
	\subcaptionbox{Small multiples of bar charts showing values from 2001 to 2011. \is{SmallMultiples2014} \label{fig:lr-time-multiples}}{\includegraphics[width=\columnwidth]{small-multiples-crop}}
...
\begin{figure}[t]
	\centering
	\subcaptionbox{Matrix view with gray cells showing connectivity. \is{Munzner2014} \label{fig:lr-network-nodelink}}[.47\columnwidth]{\includegraphics[height=.4\columnwidth]{matrix-2}}
	\hfill
