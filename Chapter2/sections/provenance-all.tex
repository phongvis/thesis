...
We categorize research in analytic provenance into four layers of the Gotz and Zhou's model~\cite{Gotz2009}. In the following sections, we discuss capture and visualization techniques for each layer.
