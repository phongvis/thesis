\section{Sensemaking}
Sensemaking in different contexts: information science~\cite{Dervin1983}, human-computer interaction~\cite{Russell1993}, and organizational studies~\cite{Weick1995}. Point to the recent review~\cite{Maitlis2014}.

\todo{extend 3 work above as DFM and PCM, but with less details, half page.}
...
%Dervin: developing theories underlying the "cognitive gap" that individuals experience when attempting to make sense of observed data.
%
%bridging the gap between the seekers and their answers
%
%mode: situation - gap - use
%(context) - don't know there
%
%weick: social context, retrospective ongoing 
%mention
