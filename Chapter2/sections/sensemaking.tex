...
\begin{figure}
	\centering
	\includegraphics[width=.8\columnwidth]{dervin}
...
\begin{figure}
	\centering
	\includegraphics[width=.8\columnwidth]{russell}
...
\begin{figure}
	\centering
	\includegraphics[width=.9\columnwidth]{pirolli-card-model}
...
\begin{figure}
	\centering
	\includegraphics[width=.9\columnwidth]{data-frame-model}
