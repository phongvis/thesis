...
The second part includes a set of four linked visualizations of the captured provenance data (\autoref{fig:sp-overview}), designed to facilitate transcription and coding (Requirement 1 and 2).
