...
\begin{figure}
	\centering
	\includegraphics[width=.85\linewidth]{outline-legend}\bigskip\\
\subcaptionbox{\label{fig:outline-right}$R_3$ is on the right side of the path.}{\includegraphics[height=.115\linewidth]{outline-right}}
\hfill
\subcaptionbox{\label{fig:outline-up}$R_3$ is on top of the path.}[.38\linewidth]{\includegraphics[height=.18\linewidth]{outline-up}}

\vspace{.5\baselineskip}

\subcaptionbox{\label{fig:outline-up-one}Left of $R_3$ is a bit greater than left of $R_2$.}[.45\linewidth]{\includegraphics[height=.18\linewidth]{outline-up-smoothing}}
\hfill
\subcaptionbox{\label{fig:outline-up-two}Right of $R_3$ is shorter than right of $R_2$.}[.45\linewidth]{\includegraphics[height=.18\linewidth]{outline-up-shorter}}
