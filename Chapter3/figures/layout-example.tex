...
\node [below=.1 of b1, text width=3cm, align=center] {$E_1$ at position of its time};
\node [below=.1 of b2, text width=3.3cm, align=center] {$E_2$ at position \\of its time, \\same level as $E_1$};
\hyphenation{giving}\node [below=.1 of b3, text width=4.2cm, align=center] {$E_2$ shifted left \\allowing $E_3$ to stay at the same level as $E_2$};
\node [below=.1 of b4, text width=4.4cm, align=center] {$E_3$ cannot be shifted  without overlap, \\$E_4$ moves up one level};
