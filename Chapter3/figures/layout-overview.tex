...
\node (r1) [schema, c1, below=-.2 of b1.south west, anchor=south west, xshift=.5cm, label=left:\Large$1$] {};
\node (r2) [schema, c2, above=.1 of r1, label=left:\Large$2$] {};
\node (r3) [schema, c3, above=.1 of r2, label=left:\Large$3$] {};
