...
\ifsetCustomMargin
  \RequirePackage[paperwidth=6.14in,paperheight=9.21in,left=20mm,right=18mm,top=20mm,bottom=18mm]{geometry}
...
\usepackage{enumitem}
\setlist[enumerate,itemize,description]{itemsep=0em,topsep=0.25em}
...
% Adjust default settings of float
\makeatletter
...
\titleformat{\section}{\sffamily\Large\color{NavyBlue}}{\thesection}{14pt}{}
\titleformat{\subsection}{\sffamily\large\color{NavyBlue}}{\thesubsection}{12pt}{}
\titleformat{\subsubsection}{\sffamily\color{NavyBlue}}{\thesubsubsection}{10pt}{}
\titleformat{\paragraph}[runin]{\sffamily\bfseries}{\theparagraph}{}{}
\titleformat{\subparagraph}[runin]{\sffamily\itshape}{\thesubparagraph}{}{}
...
% left-above-right
\titlespacing{\paragraph}{0pt}{8pt}{12pt}
\titlespacing{\subparagraph}{12pt}{6pt}{12pt}
...
\ChNumVar{\fontsize{60}{60}\usefont{T1}{phv}{m}{n}\selectfont}
%\ChTitleVar{\raggedleft\color{NavyBlue}\fontsize{20}{28}\usefont{T1}{phv}{m}{n}\selectfont}
...
% Image source
\newcommand{\is}[1]{{\emph{Image source:~\cite{#1}.}}} 
