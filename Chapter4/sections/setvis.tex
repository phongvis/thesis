...
\begin{figure}
\centering
\includegraphics[width=.45\linewidth]{figure3}
...
\begin{figure}
	\centering
	\subcaptionbox{A single color gradient.\label{fig:gradient1}}
		{\includegraphics[width=0.48\columnwidth]{figure7a}}
	\hfill
	\subcaptionbox{Multiple color gradients.\label{fig:gradient2}}
