...
\begin{figure}[ht]
	\centering
	\subcaptionbox{Each circle represents a set.}[.3\columnwidth]{\label{fig:eventmembership1}\includegraphics[width=.25\columnwidth]{figure8a}}
	\hfill
	\subcaptionbox{Each ring represents a set.}[.3\columnwidth]{\label{fig:eventmembership2}\includegraphics[width=.25\columnwidth]{figure8b}}
	\hfill
	\subcaptionbox{Each color in the gradient background represents a set.}[.3\columnwidth]{\label{fig:eventmembership3}\includegraphics[width=.25\columnwidth]{figure8c}}
