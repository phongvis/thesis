...
\begin{figure}[!htb]
	\centering
	\subcaptionbox{Before compacting.}{\includegraphics[width=.47\columnwidth]{figure10a}}
	\hfill
	\subcaptionbox{After compacting.}{\includegraphics[width=.47\columnwidth]{figure10b}}
...
\begin{figure}[!htb]
	\centering
	\subcaptionbox{Before balancing: $\theta_{green}=0.25$, $\theta_{yellow}=1$.}{\label{fig:balancing1}\includegraphics[width=.48\columnwidth]{figure11a}}
	\hfill
	\subcaptionbox{After balancing: $\theta_{green}=\theta_{yellow}=0.5$.}{\label{fig:balancing2}\includegraphics[width=.48\columnwidth]{figure11b}}
