...
\begin{figure}[ht]
	...
	\subcaptionbox{No encoding.}{\label{fig:aggregate-0}
		\includegraphics[width=.3\columnwidth]{figure12a}}
	\hfill
	\subcaptionbox{Scale with the width of the bounding rectangle.}{\label{fig:aggregate-1}
		\includegraphics[width=.3\columnwidth]{figure12b}}
	\hfill
	\subcaptionbox{Each dot is an event at when it happens.}{\label{fig:aggregate-2}
		\includegraphics[width=.3\columnwidth]{figure12c}}
	\\
	\subcaptionbox{Color code the background of the bounding rectangle.}[.45\columnwidth]{\label{fig:aggregate-3}
		\includegraphics[width=.3\columnwidth]{figure12d}}
	\hfill
	\subcaptionbox[.4\columnwidth]{Scale with the font size of the label.}[.45\columnwidth]{\label{fig:aggregate-4}
		\includegraphics[width=.3\columnwidth]{figure12e}}
